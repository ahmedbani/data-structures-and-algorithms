...
const screenForNames = (arr) => {
  // Solution code here...
  let regex = /Mr. [a-z|A-Z]|Mrs. [a-z|A-Z]|Ms. [a-z|A-Z]|Dr. [a-z|A-Z]/g;
  let newArr =[];
  arr.map(item =>{
    if(regex.test(item))
      newArr.push(item);
...
let biggerThanLuke = (arr) => {
  ...
  let newArr = [];
  arr.forEach(item=>{
    if(parseInt(arr[0].mass) < parseInt(item.mass))
...
const detectTicTacToeWin = (board) => {
  // Solution code here...
  return checkWinner(board[0][0],board[1][0],board[2][0]) || checkWinner(board[1][0],board[1][1],board[1][2]) || checkWinner(board[2][0],board[2][1],board[2][2]) || checkWinner(board[0][0],board[0][1],board[0][2]) || checkWinner(board[0][1],board[1][1],board[2][1]) || checkWinner(board[0][2],board[1][2],board[2][2]) || checkWinner(board[0][0],board[1][1],board[2][2]) || checkWinner(board[0][2],board[1][1],board[2][0]) ;
