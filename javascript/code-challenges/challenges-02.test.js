...
const addOne = (arr) => {
  // Solution code here...
  let incArr= arr.map(item => item + 1);
  return incArr;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let powArr =[];
  arr.forEach(item => powArr.push(Math.pow(2,item)));
  return powArr;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let powArr = arr.map(item => Math.pow(2,item));
  return powArr;
};
...
const charCode = (arr) => {
  // Solution code here...
  let charArr = arr.map(item => item.charCodeAt(0));
  return charArr;
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  let abilities = arr.map(item => item.ability.name);
  return abilities ;
};
